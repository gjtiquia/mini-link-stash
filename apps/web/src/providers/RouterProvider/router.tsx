...
Note: Tried hashHistory + changing to code routing (as seen in the docs), works! URL changes when navigating, use that for copy + pasting. Cannot directly do http://localhost:5173/about, but http://localhost:5173/#/about works!
